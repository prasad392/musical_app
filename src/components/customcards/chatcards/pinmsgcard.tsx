...
const Pinmsgcard:React.FC<props> = ({message,messangerName,img,time}) => {
  return (
    <View style={styles.masgCard}>
      ...
      <View style={styles.msdInfo}>
        <View style={{
            ...
            <Text style={{textAlign:'center',borderRadius:12}}> <Ionicons name='pin-outline' color={'#ffd60a'} size={28}/> </Text>
