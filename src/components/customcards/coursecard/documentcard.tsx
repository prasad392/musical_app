...
import { curriculumDocumentCardData } from '@/src/data/mochdata'
...
const Documentcard:React.FC<props> = ({data,onpress}) => {
  return (
    <>
    {
        data.length > 0 ? (
            ...
            <View style={styles.coursecard} key={item.id}>
                ...
                <TouchableOpacity style={styles.viewbtn} onPress={onpress}>
                    <Ionicons name='eye-outline' color={'#ffd60a'} size={26}/>
                    <Text style={{color:'#ffd60a',fontSize:16}}>View PDF</Text>
                </TouchableOpacity>
            </View>
        ))
        )
