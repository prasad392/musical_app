...
type props ={
    ...
    newMail: string;
    mainonclose: ()=>void;
    handleEmail: (mail: string)=>void;
}

const UpdtEmailOTPmodal:React.FC<props> = ({visible,onClose,newMail,mainonclose,handleEmail})=> {
            ...
            <Modalheader headerText='Update Email ID' onClose={onClose}/>
             <View style={styles.mailHead}>
                ...
                <Text style={{color:'#fff',fontSize:22,fontWeight:300,textAlign:'center'}}>
                    Enter the 6 digit code we sent to the  {newMail} Wrong email?</Text>
            </View>
            <CodeField
            value={value}
...
export default UpdtEmailOTPmodal
